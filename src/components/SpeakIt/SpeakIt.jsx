// Pleaaase, uncomment me!!!! I want to job
//
//
...
//   // }, [inputText]);
//   //
//   // const wordsCards = wordsExample.map((element) => {
//   //   const isGuested = element.word === inputText || element.isGuested;
//   //   if (element.word === inputText) {
//   //     setWordExample(
//   //       wordsExample.map((el) => {
//   //         const word = el;
//   //         if (element.word === el.word) {
//   //           word.isGuested = true;
//   //         }
//   //         return word;
//   //       })
...
//           </Card>
//           <Card className={styles.SpeakIt__containWords}>{wordsCards}</Card>
